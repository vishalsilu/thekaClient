...
const Profile = () => {
    ...
    // 1. Added phone to the formData state
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 py-12 min-h-screen bg-white">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                {/* --- Left Column: Edit Profile Component --- */}
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                {user.addresses.map((addr, idx) => (
                                    ...
                                    >
                                        ...
                                        <span className={`text-[9px] font-black uppercase tracking-wider px-2 py-0.5 border rounded mb-3 inline-block ${addr?.isDefault
